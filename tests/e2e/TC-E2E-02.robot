...
Validate Account Type And Details In API After UI Creation
    ...
    # 🔹 AUI STEP 1: Open application
    Open Application

    # 🔹 AUI STEP 3: Create Savings account via AUI
    to create saving account

    # 🔥 IMPORTANT: capture account id from AUI result page
    ...
    # 🔹 ZAPI STEP 4: Validate same account
